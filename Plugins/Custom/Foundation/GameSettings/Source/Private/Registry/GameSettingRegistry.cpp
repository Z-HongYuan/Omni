...
void UGameSettingRegistry::RegisterInnerSettings(UGameSetting* InSetting)
{
	...
	ensureAlwaysMsgf(nullptr == RegisteredSettings.FindByPredicate([&InSetting](UGameSetting* ExistingSetting) { return InSetting->GetDevName() == ExistingSetting->GetDevName(); }),
