...
#include "ExperiencePlayerStart.generated.h"
...
// 出生点的占用状态
enum class EExperiencePlayerStartLocationOccupancy : uint8
{
	// 完全空着，可以直接放
	Empty,
	// 有碰撞但可以找到一个传送落点
...
class AExperiencePlayerStart : public APlayerStart
{
	GENERATED_BODY()

public:
	UE_API AExperiencePlayerStart(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	UE_API EExperiencePlayerStartLocationOccupancy GetLocationOccupancy(AController* const ControllerPawnToFit) const;
