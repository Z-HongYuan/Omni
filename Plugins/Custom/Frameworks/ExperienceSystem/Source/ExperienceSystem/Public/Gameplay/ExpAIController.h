...
#include "ExpAIController.generated.h"
 ...
 */
UCLASS(MinimalAPI)
class AExpAIController : public AModularAIController
{
	GENERATED_BODY()

public:
	UE_API AExpAIController(const FObjectInitializer& ObjectInitializer);
