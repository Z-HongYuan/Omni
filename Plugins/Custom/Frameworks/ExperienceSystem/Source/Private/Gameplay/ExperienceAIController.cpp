...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ExperienceAIController)

AExperienceAIController::AExperienceAIController(const FObjectInitializer& ObjectInitializer)
...
void AExperienceAIController::ServerRestartController()
{
	// 仅服务端有权限重生
	...
	{
		AExperienceGameMode* const GameMode = GetWorld()->GetAuthGameMode<AExperienceGameMode>();
