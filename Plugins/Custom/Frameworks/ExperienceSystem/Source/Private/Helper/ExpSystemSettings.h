...
#include "ExpSystemSettings.generated.h"
...
class UExpSystemSettings : public UDeveloperSettings
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, meta=(AllowedTypes="ExpDefinition"))
