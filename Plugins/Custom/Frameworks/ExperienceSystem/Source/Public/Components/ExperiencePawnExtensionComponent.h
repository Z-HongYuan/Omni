...
class UExperiencePawnExtensionComponent : public UPawnComponent, public IGameFrameworkInitStateInterface
{
	GENERATED_BODY()

public:
	UE_API UExperiencePawnExtensionComponent(const FObjectInitializer& ObjectInitializer);
	...
	static UE_API UExperiencePawnExtensionComponent* FindPawnExtensionComponent(const AActor* Actor) { return (Actor ? Actor->FindComponentByClass<UExperiencePawnExtensionComponent>() : nullptr); }
