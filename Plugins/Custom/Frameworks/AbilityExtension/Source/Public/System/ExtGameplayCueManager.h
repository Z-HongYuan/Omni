...
#include "ExtGameplayCueManager.generated.h"
 ...
 */
UCLASS(MinimalAPI)
class UExtGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UExtGameplayCueManager() { ; }

	static UE_API UExtGameplayCueManager* Get();
