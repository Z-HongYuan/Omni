...
#include "CustomAbilityTagRelationshipMapping.generated.h"

#define UE_API GAMEABILITYSYSTEM_API

/** 定义不同能力标签之间关系的结构 */
USTRUCT()
struct FCustomAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 */
UCLASS(MinimalAPI)
class UCustomAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()

	/** 不同游戏标签之间的关系列表（哪些标签会阻挡或取消其他标签）*/
	UPROPERTY(EditAnywhere, Category = Ability, meta=(TitleProperty="AbilityTag"))
	TArray<FCustomAbilityTagRelationship> AbilityTagRelationships;
