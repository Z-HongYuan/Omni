...
#define UE_API CUSTOMINPUTSYSTEM_API
...
public:
	UE_API UCustomInputComponent();

	UE_API void AddInputMappings(const UCustomInputConfig* InputConfig, UEnhancedInputLocalPlayerSubsystem* InputSubsystem) const;
	UE_API void RemoveInputMappings(const UCustomInputConfig* InputConfig, UEnhancedInputLocalPlayerSubsystem* InputSubsystem) const;
