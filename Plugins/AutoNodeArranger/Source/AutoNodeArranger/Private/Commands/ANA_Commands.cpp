...
ANA_Commands::ANA_Commands() :
	TCommands<ANA_Commands>("AutoNodeArranger",
...
{
	// shift, ctrl, alt, cmd
	UI_COMMAND(ArrangeNodesStraight,
		"Arrange Nodes Straight",
		"Arrange Nodes with Straight mode",
		EUserInterfaceActionType::Button,
		FInputChord(EKeys::Q, true, false, false, false));
	UI_COMMAND(ArrangeNodesCenter,
		"Arrange Nodes Center",
		"Arrange Nodes with Center mode",
		EUserInterfaceActionType::Button,
		FInputChord(EKeys::X, true, false, false, false));
	UI_COMMAND(ArrangeNodesCompact,
		"Arrange Nodes Compact",
		"Arrange Nodes with Compact mode",
		EUserInterfaceActionType::Button,
		FInputChord(EKeys::V, true, false, false, false));
	UI_COMMAND(SelectConnectedGraph,
		"Select Connected Graph",
		"Select all connected nodes",
		EUserInterfaceActionType::Button,
		FInputChord(EKeys::F, true, false, false, false));
	UI_COMMAND(AddCustomConfig,
		"Add Custom Config",
		"Add custom config for the current graph type",
		EUserInterfaceActionType::Button,
		FInputChord(EKeys::Enter, true, false, false, false));
	UI_COMMAND(ToggleUseArrangement,
		"Toggle Use Arrangement",
		"Toggle the value for using the arrangement",
		EUserInterfaceActionType::Button,
		FInputChord(EKeys::SpaceBar, true, true, false, false));
}
...
void ANA_Commands::PrivateBindAllCommands() const
{
	...
	CommandBindings->MapAction(ToggleUseArrangement, FExecuteAction::CreateStatic(ANA_CommandHelper::ToggleUseArrangement));
}
...
void ANA_Commands::PrivateUnbindAllCommands() const
{
	...
	CommandBindings->UnmapAction(ToggleUseArrangement);
}
