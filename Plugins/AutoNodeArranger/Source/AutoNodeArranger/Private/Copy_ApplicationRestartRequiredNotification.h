...
public:
	void OnRestartRequired()
	{
		...
		Info.ButtonDetails.Add(FNotificationButtonInfo(LOCTEXT("RestartNow", "Restart Now"),
		...
		Info.ButtonDetails.Add(FNotificationButtonInfo(LOCTEXT("RestartLater", "Restart Later"),
